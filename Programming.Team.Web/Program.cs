...
builder.Services.AddScoped<IRepository<ExpSkill, Guid>, Repository<ExpSkill, Guid>>();
...
builder.Services.AddScoped<IBusinessRepositoryFacade<ExpSkill, Guid>, BusinessRepositoryFacade<ExpSkill, Guid, IRepository<ExpSkill, Guid>>>();
...
builder.Services.AddTransient<AddExpViewModel>();
builder.Services.AddTransient<ExpTurgidViewModel>();
builder.Services.AddTransient<AddSkillViewModel>();
builder.Services.AddTransient<SearchSelectSkillViewModel>();
builder.Services.AddTransient<AddExpSkillViewModel>();
builder.Services.AddTransient<ExpSkillTurgidViewModel>();
...
builder.Services.AddTransient<SearchExpViewModel>();
